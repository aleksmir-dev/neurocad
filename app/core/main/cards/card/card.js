// app/core/main/cards/card/card.js

class CoreMainCardsCard {
    constructor(cardsInstance) {
        ...
        this.folder = new CoreMainCardsCardFolder(this);
        this.table = new CoreMainCardsCardTable(this);
        this.module = new CoreMainCardsCardModule(this);
    ...
    async loadNodeData(nodeId) {
        try {
            ...
            if (this.currentType === 'folder') {
                const nameInput = document.querySelector('.core-main-cards-card-folder .folder-name');
                const descInput = document.querySelector('.core-main-cards-card-folder .folder-description');
                const sharedCheckbox = document.querySelector('.core-main-cards-card-folder .folder-is-shared');
                ...
                const nameInput = document.querySelector('.core-main-cards-card-table .table-name');
                const descInput = document.querySelector('.core-main-cards-card-table .table-description');
                if (nameInput) nameInput.value = node.name;
                if (descInput) descInput.value = node.description || '';
            }
        } catch (error) {
