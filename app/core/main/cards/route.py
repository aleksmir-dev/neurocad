# app/core/main/cards/route.py

from fastapi import APIRouter, Depends, HTTPException, Request, Query
from typing import Optional
from ....utils.templates import templates
from ...auth.dependencies import get_current_user
from .schema import CoreMainCardsNode
from .crud import create, update, delete, restore, get, get_list, get_deleted
from .shared import get_root

router = APIRouter(prefix="/cards", tags=["core/main/cards"])


@router.post("/node")
async def create_endpoint(
    request: Request,
    node_data: CoreMainCardsNode,
...
async def render_card(request: Request):
    try:
        ...
        return templates.TemplateResponse("core/main/cards/item.html", {
            "request": request,
            "node": node
        })
