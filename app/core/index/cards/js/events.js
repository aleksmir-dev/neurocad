// app/core/node/index/cards/js/events.js

class CoreNodeIndexCardsJsEvents {
    ...
    openModule(card) {
        ...
        if (moduleId) {
            fetch(`/core/node/index/modules/module/${moduleId}`)
                .then(response => {
    ...
    async openPermissions() {
        ...
        const { CoreNodeIndexPermissions } = await import('/static/app/core/node/index/permissions/permissions.js');
