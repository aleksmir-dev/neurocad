// app/core/node/index/cards/js/delete.js

class CoreNodeIndexCardsJsDelete {
    ...
    async deleteNode() {
        ...
        try {
            ...
            const response = await fetch(`/core/node/index/cards/node/${this.cards.selectedNodeId}?section=${section}`, {
                method: 'DELETE'
            });
