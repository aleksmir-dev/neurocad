// app/core/node/index/cards/card/module/module.js

class CoreNodeIndexCardsCardModule {
    constructor(cardInstance) {
        this.card = cardInstance;
        this.container = document.querySelector('.core-node-index-cards-card-module');
