// app/core/node/index/permissions/permissions.js

class CoreNodeIndexPermissions {
    constructor(options = {}) {
    ...
    render() {
        ...
        if (!this.modal) {
            fetch('/static/app/core/node/index/permissions/permissions.html')
    ...
    async loadPermissions() {
        ...
        try {
            ...
            const response = await fetch(`/core/node/index/permissions/module/${this.moduleKey}`);
...
if (typeof module !== 'undefined' && module.exports) {
    module.exports = CoreNodeIndexPermissions;
}