...
class Log:
    ...
    async def log_error(
        ...
        await self.log_info(target, f"ERROR: {message}", data)
    ...
    async def log_warning(
        ...
        await self.log_info(target, f"WARNING: {message}", data)
    ...
    def log_error_sync(
        ...
        self.log_info_sync(target, f"ERROR: {message}", data)
    ...
    def log_warning_sync(
        ...
        self.log_info_sync(target, f"WARNING: {message}", data)
